...
export declare function createOverlayComponent<T extends object, LoadingElementType extends LoadingElement, OverlayEventDetail>(displayName: string, controller: {
    ...
    new (props: T & ReactOverlayProps<OverlayEventDetail>): {
        ...
        present(prevProps?: (T & ReactOverlayProps<OverlayEventDetail>) | undefined): Promise<void>;
        render(): React.ReactPortal;
        context: any;
        setState<K extends never>(state: {} | ((prevState: Readonly<{}>, props: Readonly<T & ReactOverlayProps<OverlayEventDetail>>) => {} | Pick<{}, K> | null) | Pick<{}, K> | null, callback?: (() => void) | undefined): void;
